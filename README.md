...
```javascript
APERY = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-apery@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-apery@v0.1.0-umd/browser.js"></script>
```
